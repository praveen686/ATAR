...
from Modules.research_tools.codependence_algorythms.information import variation_of_information_score, get_mutual_info
from Modules.research_tools.codependence_algorythms.correlation import distance_correlation
