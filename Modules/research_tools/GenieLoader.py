...
def fetch_vbt_data(data_file_names, data_file_dirs, **kwargs):
    ...
    for file_name in data_file_names:
        matching_file_directory.append(genie_loader.find_file(file_name, data_file_dirs))
    ...
    for file_name, directory in zip(data_file_names, matching_file_directory):
        ...
        try:
            data = genie_loader.fetch_csv_data_dask(data_file_name=file_name,
            ...
            print(f'Could not load {file_name} as a timeseries thus is being loaded but not prepared {e}')
            import dask.dataframe as dd
