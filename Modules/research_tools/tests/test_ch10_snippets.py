...
from Modules.research_tools.bet_sizing_algorythms.ch10_snippets import get_signal, avg_active_signals, mp_avg_active_signals, discrete_signal
from Modules.research_tools.bet_sizing_algorythms.ch10_snippets import (bet_size_sigmoid, bet_size_power, bet_size, get_target_pos_sigmoid, get_target_pos_power, get_target_pos,
