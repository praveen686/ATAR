...
def daily_vol_triple_barrier_label_example(close_series, side_series,
    ...
    """
    This function is a example of how to use the triple barrier labeling algorythm
...
if __name__ == "__main__":
    ...
    Loads the input data using the Genie_Loader module and converts it to a format compatible with the vectorbt library.
